...
import { CallToolRequestSchema, ListToolsRequestSchema, ListUITemplatesRequestSchema, GetUITemplateRequestSchema, RenderUIRequestSchema, ValidateUIRequestSchema, } from "@modelcontextprotocol/sdk/types.js";
/**
...
const templates = [
    {
        ...
        schema: {
            ...
            allowedComponents: ["container", "text", "card", "chart", "table", "progress"],
            componentSchemas: {
                container: {
                    properties: {
    ...
    },
    {
        ...
        schema: {
            rootComponent: "form",
            allowedComponents: ["form", "input", "select", "checkbox", "radio", "textarea", "button", "text"],
            componentSchemas: {
                form: {
                    properties: {
                        action: { type: "string" },
    ...
    },
    {
        ...
        schema: {
            rootComponent: "table",
            allowedComponents: ["table", "text", "button", "input"],
            componentSchemas: {
                table: {
                    properties: {
                        data: { type: "array" },
...
async function createDashboard(args) {
...
function renderDashboard(data, context, preferences) {
...
function renderForm(data, context, preferences) {
    const ui = {
        type: "form",
        props: {
...
function renderDataTable(data, context, preferences) {
    const ui = {
        type: "table",
        props: {
            data: data?.rows || [],
